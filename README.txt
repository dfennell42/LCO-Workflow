...
submit: Submits vasp calculations. Takes argument for which type of calculations to submit. Equivalent to bash scripts submitall-vasp.sh and submitpdos-vasp.sh.
    Options: 
       struc    For pristine or vacancy structure calcs (default)
       pdos     For PDOS calculations
     --vac, -v  Submits only vacancy structure calcs
